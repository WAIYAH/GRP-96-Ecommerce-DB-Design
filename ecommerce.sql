...
-- Table: attribute_category (Nomakha)
CREATE TABLE IF NOT EXISTS attribute_category (
    category_id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL
);

-- Table: product_attribute (Nomakha)
...
-- Table: product_category (Precious -)
CREATE TABLE product_category (
    category_id INT PRIMARY KEY AUTO_INCREMENT,
    category_name VARCHAR(100) NOT NULL UNIQUE
);

-- Table: product_item (Precious)
...
-- Table: size_category (Deborah)
CREATE TABLE size_category (
    size_category_id INT PRIMARY KEY AUTO_INCREMENT,
    category_name VARCHAR(100) NOT NULL UNIQUE
);

-- Table: size_option (Joseph - Pending)
...
-- Table: attribute_type (Joseph - Pending)
...
-- Insert product categories (Precious)
...
-- Insert attribute categories (Nomakha)
INSERT INTO attribute_category (name) VALUES 
('Physical'), 
('Technical');

-- Insert attribute types (Joseph)
INSERT INTO attribute_type (type_name) VALUES 
('text'),
('number'),
('boolean');

-- Insert product attributes (Nomakha, updated to include attribute_type_id)
...
-- Insert size categories (Deborah)
INSERT INTO size_category (category_name) VALUES 
('Clothing Sizes'),
('Shoe Sizes');

-- Insert size options (Joseph)
...
-- Insert product variations (Bilha)
